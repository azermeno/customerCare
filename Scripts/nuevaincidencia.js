...
function guardarIncidencia() {
    ...
    if (val1.isvalid && val2.isvalid) {
        ...
        CustomerCare.Servicio.NuevaIncidencia(asu, dasu, usu, res, sol, tip, rin, solu, dsolu, guardada, error);
    }
}

function guardada(res, e) {
    alert("Incidencia guardada con número " + res);
